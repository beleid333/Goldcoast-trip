export const general_travel_tips = {
    title: "Essential Gold Coast Travel Tips",
    icon: "info",
    tips: [
        {
            heading: "Bookings & Operating Hours",
            icon: "calendar-check",
            content: "Many popular Gold Coast activities, tours, and shows require advance booking, especially for a group of four. We strongly recommend checking official websites for the most up-to-date operating hours for June 2025 and booking your preferred sessions online. This itinerary provides indicative hours; always verify them before your visit as they can change due to seasons or special events."
        },
        {
            heading: "Rental Car & Parking",
            icon: "car-front",
            content: "Your rental car offers great flexibility. Gold Coast Airport (OOL) has multiple on-site rental agencies. In Surfers Paradise and popular spots, parking can be limited and may incur fees. Research parking options beforehand. For the NRL game at Cbus Super Stadium, public transport is often the best choice due to limited event parking."
        },
        {
            heading: "Sun Safety",
            icon: "sun",
            content: "The Queensland sun can be strong, even in June. Pack and use sunscreen (SPF 30+), hats, and sunglasses daily to protect yourselves during outdoor adventures."
        },
        {
            heading: "Dress Code & Gear",
            icon: "shirt",
            content: "Comfortable walking shoes are a must! Some activities like TreeTop Challenge and SkyPoint Climb require enclosed footwear. Check specific activity websites for any other dress requirements (e.g., swimwear for water activities, smart casual for some evening venues)."
        },
        {
            heading: "Payments",
            icon: "credit-card",
            content: "Credit/debit cards are widely accepted. It's useful to have some cash for smaller purchases or markets."
        }
    ]
};
